...
public class CustomHashTableUsingBinarySearchTreeTest {

    private CustomHashTable<String, Integer> hashTable;

    @BeforeEach
    void setUp() {
        hashTable = new CustomHashTableUsingBinarySearchTree<>(5);
    }
    ...
    void testPutAndGetMethodsWithMultipleInputs() {
        final String[] inputs = new String[]{"Rishi", "John", "Bob", "Malcolm", "Joshua", "Christy", "Rob", "Sparrow"};
    ...
    void testRemoveMethodFromTail() {
        ...
        hashTable.remove("Sparrow");
        assertNull(hashTable.get("Sparrow"));
    }
}
